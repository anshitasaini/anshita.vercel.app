      ...
      <div className="flex flex-row items-center justify-left space-x-4 md:space-x-16">
        ...
        <div className="flex flex-col space-y-4 text-sm md:text-base lg:text-lg xl:text-xl">
          ...
          <p>
            ...
            Growth. i&apos;m also the founder of Wiser AI, an initiative to
            empower marginalized genders in computer science in shaping ethical
            and responsible AI.
          </p>
          <p>
            i&apos;ve previously founded and led various initiatives for
            inclusive tech, including Code4Care and She Codes Art, impacting
            over 2,000 students around the world through 100+ computer science
            workshops and conferences.
          </p>
          <p>
            in the past year, i&apos;ve spoken at summits, podcasts, and tech
            events reaching over 20,000 people, including being featured on the{" "}
            <a
